  ...
  vung.innerHTML = `
    ...
    <div class="bo-cuc-thanh-toan">
      ...
      <aside class="khoi-tom-tat-don">
        ...
        <p class="ghi-chu-dieu-khoan">Khi đặt hàng, bạn đồng ý với <a href="dieu-khoan-su-dung.html">Điều khoản sử dụng</a> và <a href="chinh-sach-bao-mat.html">Chính sách bảo mật</a>.</p>
      </aside>
    </div>`;
